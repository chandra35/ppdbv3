    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('operator.pendaftar.index') }}">Pendaftar</a></li>
        ...
        <div class="col-md-4">
            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    ...
                    <!-- Action Buttons -->
                    @if($pendaftar->status_verifikasi == 'pending')
                        <form action="{{ route('operator.pendaftar.verify', $pendaftar->id) }}" method="POST" class="mb-2">
                            @csrf
    ...
    <div class="modal fade" id="rejectModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('operator.pendaftar.reject', $pendaftar->id) }}" method="POST">
                    @csrf
