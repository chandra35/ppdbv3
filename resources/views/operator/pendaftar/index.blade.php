...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('operator.pendaftar.index') }}" method="GET" class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Cari</label>
                        <input type="text" name="search" class="form-control" placeholder="Nama, NISN, Email, No HP..." value="{{ request('search') }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($pendaftar->jenis_kelamin)
                                <br><small class="text-muted">{{ $pendaftar->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</small>
                            @endif
                        </td>
                        ...
                        <td>
                            <a href="{{ route('operator.pendaftar.show', $pendaftar->id) }}" class="btn btn-info btn-xs">
