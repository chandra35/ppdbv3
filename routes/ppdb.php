...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['permission:verifikasi.verify'])->group(function () {
        ...
        Route::post('/pendaftar/{id}/gelombang-nomor-tes', [PendaftarController::class, 'setGelombangNomorTes'])->whereUuid('id')->name('pendaftar.gelombang-nomor-tes');
    ...
    Route::prefix('sesi-ujian')->name('sesi-ujian.')->middleware('permission:seleksi.sesi')->group(function () {
        ...
        Route::post('/{sesiUjian}/ruangan/{ruangUjian}/input-nilai/{pesertaRuang}/auto-save', [\App\Http\Controllers\Admin\AdminNilaiController::class, 'autoSaveNilai'])->name('admin-auto-save-nilai');
...
Route::middleware(['auth'])->prefix('penguji')->name('penguji.')->group(function () {
    ...
    Route::post('/ruangan/{ruangUjian}/peserta/{pesertaRuang}/auto-save', [\App\Http\Controllers\Penguji\DashboardController::class, 'autoSaveNilai'])->name('auto-save-nilai');
