...
class PendaftarController extends Controller
{
    ...
    {
        $query = CalonSiswa::with(['user', 'jalurPendaftaran', 'gelombangPendaftaran'])->orderBy('created_at', 'desc');
    ...
    {
        $pendaftar = CalonSiswa::with(['user', 'dokumen', 'jalurPendaftaran', 'gelombangPendaftaran'])->findOrFail($id);
